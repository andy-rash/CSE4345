...
corpus = "a b c. a b. a b c. a b c. a b c d. a b c. a b. a b. a b c. a b. a b. a b. a b c. a b. e. a b. a b. a b. c d. a b. a b c. a b c d.a b c. a b. a b c. a b c. a b c d. a b c. a b. a b. a b c. a b. a b. a b. a b c. a b. e. a b. a b. a b. c d. a b. a b c. a b c d.a b c. a b. a b c. a b c. a b c d. a b c. a b. a b. a b c. a b. a b. a b. a b c. a b. e. a b. a b. a b. c d. a b. a b c. a b c d.a b c. a b. a b c. a b c. a b c d. a b c. a b. a b. a b c. a b. a b. a b. a b c. a b. e. a b. a b. a b. c d. a b. a b c. a b c d."

#tmp
print(word_frequency_dict(corpus))
#
#	TODO
#

#
#add way to save dictonaries and matricies
#numpy.save(file, arr, allow_pickle=True, fix_imports=True)
#

#
#add better method for comparing matrix similaries
#

#
#and most similar words searching
#
def most_similar(W, w2id, id2w, word, n=15):
	"""
	...
	#added
	#W = np.linalg.norm(W, ord=None, axis=None, keepdims=True)

	assert len(W) == len(w2id)
	word_id = w2id[word]
	...
	print(np.argsort(dists)[::-1][:n + 1])

	#dont take top id because that probably always the diagnol
	top_ids = np.argsort(dists)[::-1][1:n + 1]
	print(np.argsort(dists)[::-1][1:n + 1])


	#added
	#remove diagnols
	#new_diagonals = np.zeros(len(W)-1,np.float32)
	#replace diagnols in S
	#np.fill_diagonal(W, new_diagonals)
	#print(W)
	...
	#remove own vector from list
	#dlist = np.delete(dists, (word_id), axis=0)

	#top_ids = np.argsort(dists)[::-1][:n + 1]
	#print(np.argsort(dists)[::-1][:n + 1])

	return [id2w[id] for id in top_ids if id != word_id][:n]

#
# Add text cleaning and importing
#
"""
...
corpus = filter(lambda x: x in printable, corpus)
"""
...
#tmp similar words
wordn = random.randint(0, len(W)-1)
print ("word: %s" % id2w[wordn])
print(most_similar(W, w2id, id2w, id2w[wordn], n=3))
